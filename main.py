...
if __name__ == "__main__":
    ...
    parser.add_argument('-board', default='2.csv', type=str,
                        help='Name of board file (.csv).')

    parser.add_argument('-move_time', default=10, type=float, #TODO: Tannous edit - this time was 200
                        help='Time (sec) for each turn.')
    parser.add_argument('-game_time', default=20, type=float,
